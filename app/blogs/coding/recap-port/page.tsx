    ...
    <div className='mx-6 md:mx-32 font-[family-name:var(--font-noto-sans)]'>
        ...
        <div className='flex max-h-3/4 max-w-full relative -z-[1]'>
          ...
          <div className='mx-6 mt-48 md:mt-64 w-full'>            
            <p className='ref-image mb-2 text-end'>Image from @dhanavadh</p>            
          </div>
        </div>   

        {/* Heading */}
        <div className='mt-6 mb-10 border-l-4 border-blue-500 pl-4'>
            <p className='p mb-1'>10 minutes Reading</p>
        ...
        <div className='flex flex-col items-center justify-center lg:mx-24'>
          <img src='/content/recap-port/img-3.png' className='max-h-3xl rounded-lg'></img>
        ...
        {/* Image Class */}
        <div className='flex flex-col items-center justify-center lg:mx-24'>
          <img src='/content/recap-port/img-12.png' className='max-h-3xl rounded-lg'></img>
        ...
        {/* Image Class */}
        <div className='flex flex-col items-center justify-center lg:mx-24'>
          <img src='/content/recap-port/img-8.png' className='max-h-3xl rounded-lg'></img>
          <p className='image-description'>ภาพแสดงให้เห็นถึงการไม่ใช้ Hierarchy เข้ามาจัดการกับความสำคัญของข้อความ</p>
        </div>
        ...
        {/* Image Class */}
        <div className='flex flex-col items-center justify-center lg:mx-24'>
          <img src='/content/recap-port/img-9.png' className='max-h-3xl rounded-lg'></img>
